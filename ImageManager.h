...
struct texture
{
	...
	void CenterRender(Vector3 pos, float rot = 0, Vector3 size = Vector3(1, 1, 1), D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255));

	void Render(Vector3 pos, float rot = 0, Vector3 size = Vector3(1, 1, 1), RECT rect = { 0,0,0,0 }, D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255));
	void Release();
};
...
public:
	...
	void CenterRender(texture* texturePtr, Vector3 pos, float rot = 0, Vector3 size = Vector3(1, 1, 1), D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255));
	void Render(texture* texturePtr, Vector3 pos, float rot = 0, Vector3 size = Vector3(1, 1, 1), RECT rect = { 0,0,0,0 }, D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255));
